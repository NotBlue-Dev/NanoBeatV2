...
class nanoManager {
    ...
    defineNanoIp(ip) {
        ...
        // #### REMOVE THIS IS JUST FOR THE EMULATOR
        if(definedIp == 'localhost') {
            this.sendEvent('game-ip-defined', definedIp)
            this.api.setNanoIp(definedIp, definedToken, this.sendEvent)
        } else {
        // ####
